    ...
    <>
      <div className="py-4 flex flex-col items-center  ">
        ...
        <div className="text-center">
          <p className="text-2xl text-gray-800 dark:text-white text-center">
            Kurt Rodenhizer
          </p>
          <p className="text-xl font-light text-gray-500 dark:text-gray-200 text-center">
            Founder/Owner
          </p>
          <p className="max-w-sm md:max-w-2xl py-4 font-light text-gray-500 text-sm dark:text-gray-400 mx-auto">
            ...
            Adjunct Professor for the Computer Science Department at Endicott
            ...
            database systems to generate several cost and time savings policies
            and procedures.
            <br></br>
            <br></br>
        ...
        <div className="flex items-center justify-between pt-8 mx-auto text-gray-500 border-t border-gray-200 w-44">
          <a href="#">
            <svg
              ...
              height={30}
              fill="currentColor"
              className="text-xl transition-colors duration-200 hover:text-teal dark:hover:text-white"
