  ...
  const headerData = [
    {
      ...
      title: "About Us",
      paragraph:
        "we are EPD.  ePD owner and founder, is a former Business Development Program Manager for Dräger Medical Systems and Senior Product Manager .",
      link: "/about",
    },
    {
      page: "services",
      title: "Services",
      paragraph:
        "Here are our SERVICES  ePD owner and founder, is a former Business Development Program Manager for Dräger .",
      link: "/services",
    },
    {
      page: "references",
    ...
    .map((section, index) => (
      <>
        <div className="flex flex-col place-items-center h-full pt-6 justify-start text-center  w-full z-20 mx-auto  sm:mx-auto sm:max-w-lg md:max-w-2xl">
          <h1 key={index} className="text-3xl font-bold mb-3 text-gray-600">
            {section.title}
          </h1>
